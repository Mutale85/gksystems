                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table table-responsive">
                                <button class="btn btn-primary mb-3" id="addRowBtn">Add Row</button>
                                <table id="data-table" class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td contenteditable="true" class="particulars"></td>
                                            <td contenteditable="true" class="cash-in"></td>
                                            <td contenteditable="true" class="cash-out"></td>
                                            <td class="balance"></td>
